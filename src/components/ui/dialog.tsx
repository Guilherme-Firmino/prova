...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-purple-100 dark:border-purple-900 bg-white dark:bg-gray-900 p-6 shadow-lg duration-200 sm:rounded-lg',
        className
      )}
      {...props}
    >
