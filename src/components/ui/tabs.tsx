...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-lg bg-purple-50 dark:bg-purple-950 p-1 text-gray-500 dark:text-gray-400',
      className
    )}
    {...props}
  />
